...
def run_doctor(args):
            ...
            if r.status_code == 402:
                return _ConnectivityResult(
                    ...
                    ["OpenRouter account has insufficient credits. "
                     "Fix: run 'horo config set model.provider <provider>' "
    ...
    def _probe_apikey_provider(pname, env_vars, default_url, base_env,
        ...
        try:
            ...
            # GOOGLE_API_KEY/GEMINI_API_KEY always shows red in ``horo doctor``.
    ...
    # never the legitimate source for `horo doctor`.
    ...
    if hub_dir.exists():
        ...
        check_warn("Skills Hub directory not initialized", "(run: horo skills list)")
