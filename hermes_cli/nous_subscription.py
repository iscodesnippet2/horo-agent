...
# `horo tools` picker scope its entitlement gate to the selected backend, so a
...
def get_nous_subscription_features(
    ...
    *,
    ...
    # Tool Gateway via `horo model`, so direct credentials should NOT
...
# ---------------------------------------------------------------------------
# Inline Nous Portal login for the Tool Gateway picker (`horo tools`)
# ---------------------------------------------------------------------------
...
def ensure_nous_portal_access(
    *,
    ...
    Used by ``horo tools`` when a user selects a Nous-managed Tool Gateway
    backend (e.g. "Firecrawl (Nous Portal)").  Unlike ``horo model``'s Nous
    login, this:
