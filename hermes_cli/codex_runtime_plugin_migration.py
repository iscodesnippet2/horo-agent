...
MIGRATION_MARKER = (
    "# managed by horo-agent — `horo codex-runtime migrate` regenerates this section"
)
MIGRATION_END_MARKER = (
    "# end horo-agent managed section"
)
...
def _build_hermes_tools_mcp_entry() -> dict:
    ...
    so a horo installed under /opt/, /usr/local/, or a venv all work.
    ...
    # PYTHONPATH passes through so a worktree-launched horo finds the
