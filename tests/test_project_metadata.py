...
def test_pyproject_aiohttp_pins_match_lazy_slack_pin():
    ...
    If the two drift, `horo update` resolves the pyproject pin and
    ...
    assert not mismatches, (
        ...
        "LAZY_DEPS['platform.slack'] to avoid horo update downgrading "
...
def test_pyproject_pins_match_lazy_deps_pins():
    ...
    places. When they drift, `horo update` resolves the pyproject extra
    ...
    assert not drift, (
        ...
        "for every shared package — otherwise `horo update` downgrades the "
