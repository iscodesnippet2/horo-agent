...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and horo-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # horo-agent (tests/skills/)
]
