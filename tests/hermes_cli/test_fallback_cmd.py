"""Tests for `horo fallback` — chain reading, add/remove/clear, legacy migration."""
...
class TestListCommand:
    def test_list_empty(self, isolated_home, capsys):
        ...
        assert "horo fallback add" in out
...
class TestArgparseWiring:
    """Verify `horo fallback` is wired into main.py's argparse tree.
