"""Tests for IRC gateway configuration via `horo setup gateway` UI.
...
class TestIRCFreshInstallDiscovery:
    ...
    def test_irc_status_configured_when_env_set(self, monkeypatch):
        ...
        try:
            ...
            monkeypatch.setenv("IRC_CHANNEL", "#horo")
...
class TestIRCGatewaySetupFreshInstall:
    """Simulate the full `horo setup gateway` experience with IRC present."""
