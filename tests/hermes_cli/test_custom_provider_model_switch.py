"""Tests that `horo model` always shows the model selection menu for custom
...
class TestCustomProviderModelSwitch:
    ...
    def test_bare_custom_current_provider_matches_env_base_url_before_first_fallback(
        ...
        """`horo model` must mark the custom provider matching model.base_url
...
class TestCustomProviderDiscoverModels:
    """#18726: honor ``discover_models: false`` in the terminal ``horo model``
