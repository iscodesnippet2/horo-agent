...
# expanded text is what flows into the agent loop and may be processed by
# memory. ``extract_user_instruction_from_skill_message`` recovers just the
...
# the relevant skill marker tests.
# ---------------------------------------------------------------------------
